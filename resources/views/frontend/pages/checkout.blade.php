...
@section('main-content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            <li><a href="{{route('home')}}">Hogar<i class="ti-arrow-right"></i></a></li>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                ...
                                <p>¡Solo faltan unos pasos más para completar tu compra de forma segura!</p>
                                <!-- Form -->
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            <label>Dirección Línea 1<span>*</span></label>
    ...
    <div class="checkbox">
        ...
        <form-group>
            <input name="payment_method"  type="radio" value="cod" required> <label> Contra reembolso</label><br>
            <!-- <input name="payment_method"  type="radio" value="paypal"> <label> PayPal</label><br> -->
            <input name="payment_method"  type="radio" value="cardpay" required> <label> Pago con tarjeta</label><br>
            ...
            <div id="creditCardDetails" style="display: none;">
                ...
                <input type="text" id="cvv" name="cvv" maxlength="3"><br>
                                ...
                                <div class="single-widget get-button">
                                    <div class="content">
                                        <div class="button">
                                            <button type="submit" class="btn">PROCESANDO</button>
                                        </div>
                                    </div>
                                </div>
                                <!--/ End Button Widget -->
...
<!-- Fin del servicio único -->
</div>
<div class="col-lg-3 col-md-6 col-12">
<!-- Inicio del servicio único -->
<div class="single-service">
<i class="ti-lock"></i>
<h4>Pago seguro</h4>
<p>Pago 100 % seguro</p>
...
<p>Suscríbete a nuestro boletín informativo y obtén un <span>10%</span> de descuento en tu primera compra</p>
