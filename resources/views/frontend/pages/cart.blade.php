			...
			<div class="row">
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							<li><a href="{{('home')}}">Hogar<i class="ti-arrow-right"></i></a></li>
								...
								@else
										<tr>
											<td class="text-center">
												No hay carros disponibles. <a href="{{route('product-grids')}}" style="color:blue;">Continuar comprando</a>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">tu pagas<span>${{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">tu pagas<span>${{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
