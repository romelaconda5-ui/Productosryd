...
@section('title','Exquisitos RYD || Detalle del Blog')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Detalle del Blog</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author">
                                            <a href="javascript:void(0);"><i class="fa fa-user"></i>Por {{$post->author_info['name']}}</a>
                                            <a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('d M, Y')}}</a>
                                            <a href="javascript:void(0);"><i class="fa fa-comments"></i>Comentarios ({{$post->allComments->count()}})</a>
                                        </span>
                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn">
                                                            <span class="comment_btn comment">Publicar Comentario</span>
                                                            <span class="comment_btn reply" style="display: none;">Responder Comentario</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="main-sidebar">
                                ...
                                <div class="single-post">
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="comment">
                                            ...
                                            <li><i class="fa fa-user" aria-hidden="true"></i>{{$post->author_info->name ?? 'Anónimo'}}</li>
                                        </ul>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Suscríbete y recibe las últimas novedades.</h4>
