                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Barra del blog</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">Hoja informativa</h3>
                            <div class="letter-inner">
                                ...
                                <form method="POST" action="{{route('subscribe')}}" class="form-inner">
                                    ...
                                    <button type="submit" class="btn " style="width: 100%">Entregar</button>
                                </form>
                            </div>
                        </div>
                        <!--/ End Single Widget -->
