      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="cat_id" id="cat_id" class="form-control">
              <option value="">--Selecciona cualquier categoría--</option>
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="M"  @if( in_array( "M",$data ) ) selected @endif>Grande</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>De Descuento</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="active" {{(($product->status=='active')? 'selected' : '')}}>Activa</option>
            <option value="inactive" {{(($product->status=='inactive')? 'selected' : '')}}>Inactiva</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
