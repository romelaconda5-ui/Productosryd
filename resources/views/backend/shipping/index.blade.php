...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista de envío</h6>
      <a href="{{route('shipping.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Añadir envío</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">¡No se encontraron envíos! Por favor, crea un envío.</h6>
        @endif
      </div>
    </div>
</div>
