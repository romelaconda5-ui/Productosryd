...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          <label for="post_cat_id">Categoría <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--Seleccione cualquier etiqueta--</option>
        ...
        <div class="form-group">
          ...
          <select name="added_by" class="form-control">
              <option value="">--Seleccione cualquiera--</option>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="active" {{(($post->status=='active')? 'selected' : '')}}>Activa</option>
            <option value="inactive" {{(($post->status=='inactive')? 'selected' : '')}}>Inactiva</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
