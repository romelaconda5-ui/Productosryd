              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Lo entendemos, a veces pasan cosas. ¡Ingresa tu correo electrónico a continuación y te enviaremos un enlace para restablecer tu contraseña!</p>
                  </div>
                    @if (session('status'))
